...
export async function POST(request: Request) {
  try {
    ...
    const systemInstruction = `
      Bạn là một trợ lý thông minh chuyên sửa lỗi định dạng Vật lý.
      Nhiệm vụ: Chuyển đổi toàn bộ các biểu thức Vật lý, công thức trong đoạn văn bản/HTML sau về chuẩn LaTeX được bọc trong cặp dấu $...$ (inline) hoặc $$...$$ (block).
      KHÔNG thay đổi bất kỳ chữ nghĩa bình thường hay cấu trúc HTML nào, chỉ chèn dấu $ vào đúng vị trí công thức vật lý đang bị lỗi.
