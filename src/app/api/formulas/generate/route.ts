...
export async function POST(request: Request) {
  try {
    ...
    const prompt = `Bạn là một Giáo sư Vật lý cực kỳ giỏi và là tác giả của những cuốn từ điển Vật lý chi tiết nhất.
Nhiệm vụ của bạn là liệt kê ĐẦY ĐỦ VÀ CHÍNH XÁC NHẤT TẤT CẢ các công thức Vật lý thuộc chủ đề: "${context}".
