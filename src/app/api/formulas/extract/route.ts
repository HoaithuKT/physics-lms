...
export async function POST(request: Request) {
  try {
    ...
    const prompt = `Bạn là một Giáo sư Vật lý và chuyên gia bóc tách dữ liệu (OCR).
Tôi sẽ cung cấp cho bạn một hoặc nhiều hình ảnh chứa các công thức Vật lý.
Hệ thống hiện tại đang có danh sách các chuyên đề/chương bài sau:
${categoriesString}

Nhiệm vụ của bạn là:
1. Đọc và bóc tách TẤT CẢ các công thức Vật lý xuất hiện trong CÁC bức ảnh này.
