...
export default function RemedialModal({ isOpen, onClose, resultData, onSuccess }: RemedialModalProps) {
  ...
  const handleAutoGenerate = async () => {
    ...
    alert("Tính năng sinh tự động bằng API AI đang được phát triển. Tạm thời Cô có thể dùng Tab 'Sinh bằng Prompt' ạ.");
    setIsGenerating(false);
    setActiveTab('manual');
  };
        ...
        <div className="p-4 md:p-6 flex-1 overflow-y-auto">
          ...
          {activeTab === 'auto' && (
            <div className="text-center py-12">
              ...
              <p className="text-zinc-500 text-sm mb-6 max-w-md mx-auto">Hệ thống sẽ gọi API ngầm để phân tích các câu sai và tự tạo ra câu hỏi mới tương tự mà không cần Cô can thiệp.</p>
              <button 
            ...
            <div className="space-y-4">
              ...
              {wrongImages.length > 0 && (
                <div className="bg-blue-50 border border-blue-200 p-4 rounded-xl">
                  ...
                  <p className="text-xs text-blue-600 mb-3">Gemini không tự đọc được link ảnh. Cô hãy <strong>chuột phải vào từng ảnh &rarr; Sao chép hình ảnh</strong> và dán (Ctrl+V) vào cùng khung chat Gemini nhé!</p>
              ...
              <div className="pt-4 border-t border-zinc-100 flex justify-end">
                <button 
                  ...
                  className="bg-amber-600 hover:bg-amber-700 text-white px-6 py-2.5 rounded-xl font-bold transition-colors disabled:opacity-50"
                >
