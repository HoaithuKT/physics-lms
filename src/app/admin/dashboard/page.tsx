...
export default function AdminDashboard() {
  ...
  const statCards = [
    ...
    { title: "Tổng Khóa Học", value: stats.totalCourses, icon: BookOpen, color: "from-orange-400 to-amber-500", shadow: "shadow-amber-500/30", bg: "bg-orange-50" },
  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-8 bg-[#F8FAFC] min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-3xl shadow-sm border border-gray-100">
        <div>
          <h1 className="text-3xl font-black bg-clip-text text-transparent bg-gradient-to-r from-orange-600 to-indigo-600 mb-2">Trung Tâm Điều Khiển</h1>
          <p className="text-gray-500 font-medium">Theo dõi và quản lý mọi hoạt động trên nền tảng Physics LMS</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-orange-900/20">
          {/* Awesome Background */}
          <div className="absolute inset-0 bg-gradient-to-br from-orange-600 via-amber-600 to-indigo-700"></div>
          ...
          <div className="relative z-10 p-8 h-full flex flex-col">
            ...
            <p className="text-orange-100 text-sm mb-8 opacity-90 font-medium">Bảng điều khiển siêu tốc dành cho Quản trị viên</p>
            
            <div className="space-y-4 flex-1">
              {/* Cẩm nang để đầu và tô nổi: thầy cô mới vào là thấy ngay chỗ đọc hướng dẫn,
                  không phải mò tới nút ❓ trong trang soạn bài. */}
              <Link href="/admin/huong-dan" className="group flex items-center justify-between bg-yellow-300/90 hover:bg-yellow-200 p-4 rounded-2xl border border-yellow-100/60 transition-all duration-300 hover:scale-[1.02] hover:shadow-lg">
