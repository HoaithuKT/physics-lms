    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Quản lý bách khoa toàn thư Vật lý với sự hỗ trợ của AI</p>
        </div>
              ...
              <div className="bg-white p-4 rounded-2xl border border-gray-200 shadow-sm flex flex-wrap items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button 
                    ...
                    className="bg-orange-500 text-white px-4 py-2 rounded-xl font-semibold hover:bg-orange-600 transition-all flex items-center gap-2"
                  >
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-4xl overflow-hidden flex flex-col max-h-[95vh]">
            <div className="p-6 border-b border-gray-100 flex justify-between items-center bg-gray-50 shrink-0">
              <h3 className="text-xl font-black text-gray-800 flex items-center gap-2">
                <UploadCloud className="w-6 h-6 text-orange-600" /> Công cụ Bóc tách Ảnh / File
              </h3>
              <div className="flex bg-white rounded-xl p-1 border border-gray-200 shadow-sm">
                <button
                  onClick={() => setExtractMode('direct')}
                  className={`px-4 py-1.5 text-sm font-bold rounded-lg transition-all ${extractMode === 'direct' ? 'bg-orange-500 text-white shadow-md' : 'text-gray-500 hover:bg-gray-50'}`}
                >
                  Trực tiếp (API)
                </button>
                <button
            ...
            <div className="p-8 overflow-y-auto flex-1 bg-white">
              {extractMode === 'direct' ? (
                <div className="space-y-6">
                  <div className="bg-orange-50 border border-orange-100 p-4 rounded-xl text-orange-800 text-sm font-medium">
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-gray-50 p-4 rounded-xl border border-gray-200">
                    ...
                    <select
                      value={selectedApiKeyIndex}
                      onChange={e => setSelectedApiKeyIndex(e.target.value === 'auto' ? 'auto' : Number(e.target.value))}
                      className="px-4 py-2 bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-orange-500 outline-none font-medium shrink-0"
                    >
                  ...
                  <div 
                    ...
                    onPaste={handlePaste}
                    tabIndex={0}
                    className="border-2 border-dashed border-gray-300 rounded-3xl p-12 flex flex-col items-center justify-center bg-gray-50 hover:bg-orange-50/50 hover:border-orange-400 transition-all focus:outline-none focus:ring-2 focus:ring-orange-500/20 group cursor-pointer relative min-h-[300px]"
                    onClick={() => {
                      ...
                      <div className="w-full">
                        ...
                        <div className="mt-6 flex justify-center">
                           <button 
                             ...
                             className="text-orange-600 bg-orange-50 px-4 py-2 rounded-lg font-semibold hover:bg-orange-100 flex items-center gap-2 transition-colors cursor-pointer"
                           >
            ...
            <div className="p-6 border-t border-gray-100 shrink-0 flex gap-4 bg-gray-50">
              ...
              {extractMode === 'direct' ? (
                <button 
                  ...
                  className="flex-1 px-6 py-3 bg-orange-500 text-white rounded-xl font-bold hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-orange-500/30 flex justify-center items-center gap-2 transition-all"
                >
