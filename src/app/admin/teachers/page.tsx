    ...
    <div className="p-8 w-full max-w-7xl mx-auto space-y-8">
      ...
      <div className="flex justify-between items-center">
        ...
        <button 
          ...
          className="bg-orange-600 text-white px-5 py-2.5 rounded-xl font-bold hover:bg-orange-700 flex items-center gap-2 shadow-sm transition-colors"
        >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {t.permissions && t.permissions.length > 0 ? (
                        t.permissions.map((p: string) => {
                          ...
                          return <span key={p} className="bg-orange-100 text-orange-800 text-xs px-2 py-1 rounded-md font-medium">{name}</span>
                        })
                      ) : (
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-sm">
          <div className="bg-white rounded-3xl w-full max-w-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-orange-600/20 disabled:bg-gray-100"
              ...
              {!editUserId && (
                <div>
                  ...
                  <input 
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-gray-200 focus:ring-2 focus:ring-orange-600/20"
                    ...
                    return (
                      <div 
                        ...
                        className={`flex items-center gap-3 p-3 rounded-xl border cursor-pointer transition-colors ${
                          isSelected ? 'bg-orange-50 border-orange-200 text-orange-800' : 'border-gray-200 text-gray-600 hover:bg-gray-50'
                        }`}
                      >
            ...
            <div className="p-4 border-t border-gray-100 bg-gray-50 flex justify-end gap-3 shrink-0">
              ...
              <button onClick={handleSubmit} disabled={isSubmitting} className="px-6 py-2.5 bg-orange-600 text-white font-bold rounded-xl hover:bg-orange-700 flex items-center gap-2 transition-colors disabled:opacity-50">
