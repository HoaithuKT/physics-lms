 ...
 * ra "TỔNG ĐIỂM ..... / 2,75đ" trong khi đề là 10 điểm.
 */
    ...
    <div className="p-4 sm:p-8 max-w-[1400px] mx-auto">
      ...
      <div
        ...
        className={`rounded-2xl border-2 border-dashed p-8 text-center mb-5 transition-colors ${
          keo ? 'border-orange-500 bg-orange-50' : 'border-slate-300 bg-white'}`}
      >
        ...
        <label className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-orange-600 text-white
                          font-bold cursor-pointer hover:bg-orange-700">
          <FileImage className="w-4 h-4" /> Chọn tệp
          <input type="file" multiple accept="image/*,application/pdf" className="hidden"
                 onChange={e => { napTep([...(e.target.files || [])]); e.target.value = ''; }} />
        </label>
        {dangDoc && (
          <p className="mt-3 text-orange-700 font-bold flex items-center justify-center gap-2">
        ...
        <div className="bg-white rounded-2xl border border-slate-200 overflow-hidden">
          <div className="px-5 py-3 border-b border-slate-100 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button onClick={themBaiGiayKhac}
                      className="text-[13px] font-bold text-orange-700 hover:text-orange-900
                                 bg-orange-50 px-3 py-1.5 rounded-lg">
          ...
          <div className="px-5 py-3 border-b border-slate-100 font-black text-slate-800
            ...
            <span className="font-medium text-[12.5px] text-slate-500">
              ...
              <Link href={`/admin/classes/${classId}?tab=scores`}
                    className="font-bold text-orange-700 underline hover:text-orange-900">
                Sổ điểm lớp
              </Link>
        ...
        <div className="fixed inset-0 z-[90] bg-black/60 flex items-center justify-center p-4"
          ...
          <div className="bg-white rounded-2xl w-full max-w-5xl max-h-[92vh] flex flex-col"
            ...
            <div className="px-5 py-3 border-b border-slate-200 flex items-center gap-3">
              ...
              <span className="ml-auto font-black text-orange-700">
...
function ChiTietBai({ bai, kq, ten, onDong, onSua, onXoa }: {
  ...
  /* Câu nét MỜ: máy vẫn chấm bình thường, nhưng nét tô nhạt tới mức không tách được với
     ...
     tờ thật thì trung bình chỉ 1-2 câu mỗi tờ rơi vào đây. */
