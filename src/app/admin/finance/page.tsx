    ...
    <div className="p-8 w-full max-w-7xl mx-auto font-sans">
      ...
      <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-3">
          ...
          <button onClick={handleAutoCenterFee} className="flex items-center gap-2 bg-orange-600 text-white px-4 py-2.5 rounded-xl font-bold hover:bg-orange-700 transition-colors shadow-sm">
      ...
      {loading ? (
        <div className="py-20 text-center"><Loader2 className="w-10 h-10 animate-spin text-orange-600 mx-auto" /></div>
      ) : (
        <>
          {/* STATS */}
          ...
          <div className="bg-white rounded-2xl w-full max-w-md shadow-2xl overflow-hidden animate-in zoom-in-95">
            ...
            <form onSubmit={handleSaveExpense} className="p-6 space-y-4">
              <div>
                ...
                <input required type="text" value={expForm.title} onChange={e=>setExpForm({...expForm, title: e.target.value})} className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl font-bold outline-none focus:border-orange-500" />
              </div>
              <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input required type="date" value={expForm.date} onChange={e=>setExpForm({...expForm, date: e.target.value})} className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-orange-500 text-sm" />
                </div>
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-1">Phân loại</label>
                  <select value={expForm.category} onChange={e=>setExpForm({...expForm, category: e.target.value})} className="w-full px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl outline-none focus:border-orange-500 text-sm">
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-100 mt-6">
                ...
                <button type="submit" disabled={savingExp} className="px-6 py-2 bg-orange-600 text-white font-bold rounded-xl flex items-center gap-2 hover:bg-orange-700">
