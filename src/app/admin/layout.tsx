        ...
        <div className={`p-6 border-b border-white/10 flex items-center gap-3 text-white ${isCollapsed ? 'justify-center px-0' : ''}`}>
          ...
          {!isCollapsed && (
            <div className="overflow-hidden">
              <h1 className="font-bold text-lg leading-tight whitespace-nowrap">Physics LMS</h1>
              <p className="text-[10px] text-orange-400 font-semibold uppercase tracking-widest mt-1 whitespace-nowrap">Dashboard</p>
            </div>
          )}
        </div>
        ...
        {!isTopbarHidden && (
          <header className="bg-white border-b border-gray-200 px-8 py-4 flex justify-between items-center sticky top-0 z-10 shadow-sm transition-all">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="w-10 h-10 bg-orange-100 text-orange-700 rounded-full flex items-center justify-center font-bold border-2 border-orange-200 cursor-pointer">
