  ...
  return (
    <div className="max-w-4xl mx-auto pb-20">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <button onClick={() => router.push('/admin/courses')} className="text-orange-600 font-medium text-sm flex items-center gap-2 hover:underline mb-2">
        ...
        <div className="flex gap-3">
          ...
          <button 
            ...
            disabled={isSaving}
            className={`px-5 py-2.5 rounded-xl font-medium transition-colors flex items-center gap-2 disabled:opacity-50 ${status === 'published' ? 'bg-orange-600 text-white hover:bg-orange-700 shadow-sm shadow-orange-600/20' : 'bg-white border border-orange-600 text-orange-600 hover:bg-orange-50'}`}
          >
          ...
          <div className="space-y-6">
            <div>
              ...
              <input 
                ...
                placeholder="VD: Vật lý Lớp 9 - Đại số Cơ bản" 
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <select 
                  ...
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 outline-none"
                >
            ...
            <div>
              ...
              <textarea 
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all resize-none"
              ></textarea>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-4">
              ...
              <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-orange-500 hover:bg-orange-50 transition-colors">
                <input 
                  type="file" 
                  accept="image/*"
                  onChange={async (e) => {
