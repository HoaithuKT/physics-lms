    ...
    <div className="p-8 w-full">
      <div className="flex justify-between items-center mb-8">
        ...
        <Link 
          ...
          className="flex items-center gap-2 bg-orange-600 text-white px-5 py-2.5 rounded-xl font-medium hover:bg-orange-700 hover:shadow-lg hover:shadow-orange-600/20 transition-all"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {courses.map(course => (
            <div key={course.id} className="bg-white rounded-2xl border border-gray-100 p-6 hover:shadow-xl hover:shadow-black/5 hover:-translate-y-1 transition-all group">
              ...
              <div className="mb-6">
                <span className="text-xs font-bold uppercase tracking-wider text-orange-600 bg-orange-50 px-3 py-1.5 rounded-lg border border-orange-100/50">
