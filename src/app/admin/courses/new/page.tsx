...
export default function NewCoursePage() {
  ...
  useEffect(() => {
    const loadCategories = async () => {
      ...
      if (data) {
        // Áp dụng thuật vật lý phân loại tự động nếu thiếu type
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex gap-3">
          ...
          <button 
            ...
            disabled={isSaving}
            className="px-5 py-2.5 rounded-xl bg-orange-600 text-white font-medium hover:bg-orange-700 shadow-sm shadow-orange-600/20 transition-colors flex items-center gap-2 disabled:opacity-50"
          >
