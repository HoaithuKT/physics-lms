  ...
  return (
    <div className="p-8 max-w-4xl mx-auto w-full">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div className="bg-gradient-to-r from-orange-500 to-amber-600 p-8 text-white flex items-center gap-4">
          <div className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center border-2 border-white/30">
            <PlusCircle className="w-8 h-8 text-white" />
          </div>
          <div>
            <h1 className="text-2xl font-black">Tạo Khóa học mới</h1>
            <p className="text-orange-50 font-medium opacity-90">Điền thông tin bên dưới để thêm khóa học vào hệ thống</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div className="space-y-2">
            ...
            <input 
              ...
              placeholder="VD: Vật lý Đại Số Lớp 12 - Ôn thi THPT"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <select 
                ...
                className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 bg-white"
              >
          ...
          <div className="pt-6 border-t border-gray-100 flex justify-end gap-3">
            ...
            <button 
              type="submit"
              disabled={saving}
              className="flex items-center gap-2 px-6 py-3 font-bold text-white bg-orange-600 hover:bg-orange-700 rounded-xl shadow-lg shadow-orange-600/20 transition-all disabled:opacity-70"
            >
