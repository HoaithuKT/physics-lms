                            ...
                            <div key={i} className={`flex items-start gap-2 p-2 rounded-lg border ${i === q.answerIndex ? "border-green-400 bg-green-50 shadow-sm" : "border-slate-100 bg-slate-50"}`}>
                              ...
                              {isEditingThis ? (
                                <div className="flex-1 flex flex-col gap-1">
                                  ...
                                  />
                                  <button onClick={() => handleFixLatexAI(idx, false, i)} className="text-[10px] text-purple-600 bg-purple-50 w-fit px-2 rounded hover:bg-purple-100">✨ Sửa Vật lý</button>
                                </div>
                              ) : (
                                <div className={`flex-1 overflow-hidden ${i === q.answerIndex ? "text-green-800 font-medium" : "text-slate-600"}`}>
                                  <PhysicsRenderer htmlContent={opt} />
                                </div>
                              )}
                            </div>
                          ))}
                            ...
                            return (
                              <div key={i} className="flex items-center gap-2 p-2 rounded-lg border border-slate-200 bg-white">
                                ...
                                {isEditingThis ? (
                                  ...
                                  <div className="flex-1 text-slate-700 overflow-hidden"><PhysicsRenderer htmlContent={opt} /></div>
                                )}
                      ...
                      {q.type === 'essay' && (
                        <div className="mt-2 bg-slate-50 p-3 rounded-lg border border-slate-200">
                           ...
                           {isEditingThis ? (
                             ...
                             <div className="mt-2 text-slate-600"><PhysicsRenderer htmlContent={q.answerText || "(Chưa có đáp án mẫu)"} /></div>
                           )}
                        </div>
                      )}
