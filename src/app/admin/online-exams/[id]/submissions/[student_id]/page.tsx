                   ...
                   {isEssay ? (
                     ...
                     <div className="text-slate-700 font-bold">
                       {q.type === 'multiple_choice' && stuAns !== undefined && stuAns !== null ? (
                         <PhysicsRenderer htmlContent={q.options[stuAns]} />
                       ) : (
                 ...
                 {isEssay && (
                   <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
                     ...
                     <div className="bg-amber-50 rounded-xl p-5 border border-amber-200 flex flex-col justify-center items-center">
                       <label className="font-bold text-amber-800 mb-2">ĐIỂM CÂU NÀY (Giáo viên nhập):</label>
                       <input 
                         type="number" 
                         step="0.25"
                         min="0"
                         ...
                         className="w-32 text-center text-2xl font-black text-amber-700 px-4 py-2 border-2 border-amber-300 rounded-xl focus:outline-none focus:ring-4 focus:ring-amber-100"
                       />
                     </div>
                   </div>
                 )}
