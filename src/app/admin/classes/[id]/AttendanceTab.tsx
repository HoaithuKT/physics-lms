                  ...
                  <table className="w-full text-center">
                    <thead>
                      <tr className="bg-gray-50/50">
                        <td className="py-4 text-gray-500 font-bold text-sm uppercase">Sĩ số</td>
                        <td className="py-4 text-gray-500 font-bold text-sm uppercase">Có mặt</td>
                        <td className="py-4 text-gray-500 font-bold text-sm uppercase">Có phép</td>
                        <td className="py-4 text-gray-500 font-bold text-sm uppercase">Không phép</td>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="py-4 text-3xl font-black text-gray-800">{filteredEnrollments.length}</td>
                        <td className="py-4 text-3xl font-black text-green-600">{filteredEnrollments.filter(en => attendance[en.profiles.id]?.status === 'PRESENT').length}</td>
