  ...
  return (
    <div className="h-screen overflow-y-auto bg-gray-50 py-10 px-4 sm:px-6 lg:px-8 font-sans">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Header */}
        <div className="bg-[#f97316] rounded-t-2xl p-8 text-white relative overflow-hidden">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li className="flex items-start gap-2">
                  ...
                  <span><strong>Tài khoản & Mật khẩu:</strong> Thông tin đăng nhập sẽ được Cô Hoài Thu cung cấp trực tiếp cho bạn hoặc phụ huynh.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-500 font-bold mt-0.5">•</span>
        ...
        <div className="mt-8 text-center text-sm text-gray-500 pb-10">
          Cần hỗ trợ thêm? Vui lòng liên hệ Cô Hoài Thu hoặc trợ giảng để được giải đáp.
        </div>
      </div>
    </div>
  );
