  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100/60 p-6">
          <div className="flex items-center space-x-2 mb-6">
            <BookMarked className="w-5 h-5 text-[#f97316]" />
            <h3 className="font-semibold text-gray-800">Lớp học đang mở</h3>
          </div>
          
          <div className="space-y-5">
            <ClassItem name="Vật lý 11" subject="Toán" />
            <ClassItem name="Anh 6" subject="Toán" />
            <ClassItem name="Vật lý 9" subject="Toán" />
            <ClassItem name="Vật lý 9A" subject="Vật lý · Thứ 2 (7h30-9h), Thứ 4 (7h30-9h), Thứ 6 (7h30-9h)" />
          </div>
        </div>
      </div>
    </div>
...
function ClassItem({ name, subject }: any) {
  return (
    <div className="flex justify-between items-center group">
      <div>
        <p className="font-semibold text-gray-800 text-sm group-hover:text-[#f97316] transition-colors">{name}</p>
        <p className="text-[11px] text-gray-400 mt-0.5">{subject}</p>
      </div>
      <span className="bg-[#eaf5f3] text-[#f97316] text-[11px] px-3 py-1 rounded-full font-semibold border border-[#f97316]/10">
        Đang mở
      </span>
    </div>
  );
