    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-amber-50">
        <div className="bg-white p-12 rounded-[2rem] shadow-xl text-center">
          <div className="w-24 h-24 bg-amber-100 text-amber-600 rounded-full flex items-center justify-center mx-auto mb-6 text-4xl font-black">✓</div>
          <h1 className="text-2xl font-black text-amber-800 mb-2">Đã hoàn thành!</h1>
          <p className="text-amber-600 font-medium mb-8">Bạn đã làm bài tập gỡ điểm này rồi.</p>
          <Link href="/student/dashboard" className="bg-amber-600 text-white px-8 py-3 rounded-xl font-bold hover:bg-amber-700 transition-colors">
            Về trang chủ
          </Link>
        </div>
      </div>
