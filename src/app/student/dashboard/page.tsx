 ...
 *
 * Trước đây điện thoại dựng từ mảng này, còn màn rộng lại là mấy nút gõ tay riêng - hai
...
const MUC_HOC_SINH: MucHocSinh[] = [
  ...
  { tab: 'courses',  nhan: 'Khóa học',    nhanDai: 'Khóa học bài giảng',    Icon: BookOpen,      mau: 'bg-orange-50 text-orange-600' },
  ...
  { tab: '',         nhan: 'Sổ tay',      nhanDai: 'Sổ tay Vật lý',         Icon: Library,       mau: 'bg-indigo-50 text-indigo-600', duong: '/student/handbook' },
];
  ...
  return (
    <div className="w-full flex-1 min-h-screen overflow-y-auto bg-gray-50 pb-24 md:pb-20 font-sans">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 text-sm font-bold text-orange-700 hover:text-orange-800
                         bg-orange-50 hover:bg-orange-100 px-3 py-2 rounded-lg transition-colors"
            >
      ...
      <HuongDanSoanBaiModal
        ...
        mau="bg-gradient-to-r from-orange-600 to-amber-500"
      />
