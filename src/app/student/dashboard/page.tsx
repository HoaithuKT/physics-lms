      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-20 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 h-20 flex items-center justify-between">
          <div className="flex items-center -ml-2">
            <img src="/logo.jpg" alt="Digital Physics by Phuc" className="h-16 sm:h-20 w-auto object-contain mix-blend-multiply scale-[1.15] origin-left drop-shadow-sm" />
          </div>
      ...
      <div className="p-6 sm:p-8 max-w-[1400px] mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1.5 font-medium">Chào mừng <span className="font-bold text-orange-600">{profile?.full_name}</span> trở lại với góc học tập!</p>
          </div>
        ...
        <div className="w-full">
          ...
          {activeTab === 'info' && (
            <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
              <div className="bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-orange-600 relative p-10 sm:p-14 text-white flex items-center gap-8 overflow-hidden">
                  ...
                  {courses.map((course) => (
                    <div key={course.id} className="bg-white rounded-[2rem] border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-orange-900/5 transition-all duration-300 hover:-translate-y-2 overflow-hidden group flex flex-col">
                      ...
                      <div className="p-8 sm:p-10 flex flex-col flex-1">
                        ...
                        <h3 className="text-2xl font-black text-gray-800 mb-3 group-hover:text-orange-600 transition-colors line-clamp-2 leading-tight">
                          {course.title}
                        </h3>
