...
export default function PendingApprovalPage() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#fff7ed] p-4 font-sans">
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden border border-orange-50 text-center p-10">
        ...
        <a 
          href="/login"
          className="inline-flex items-center justify-center w-full bg-[#f97316] text-white font-semibold py-3.5 rounded-xl hover:bg-[#ea580c] transition-colors shadow-md shadow-[#f97316]/20"
        >
