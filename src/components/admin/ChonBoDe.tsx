  ...
  return (
    <select
      ...
      className={`flex-1 min-w-[125px] border rounded-lg px-2.5 py-1.5 text-[13px] font-medium outline-none
                  ${giaTri ? "border-orange-400 bg-orange-50 text-orange-800" : "border-slate-300 text-slate-600"}`}
    >
              ...
              return (
                ...
                <div
                  ...
                  className={`border-b border-slate-200/70 last:border-b-0 flex items-stretch
                              transition-colors ${chon ? "bg-orange-50" : "bg-white hover:bg-slate-50"}`}
                >
                  <button
                    onClick={() => onChon(b.id)}
