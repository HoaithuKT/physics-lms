                   ...
                   >
                     ...
                     <div className="flex-1 min-w-0">
                        <div className="flex flex-col gap-1.5 mb-2">
                           ...
                           {q.lesson && <div className="font-bold text-orange-800 text-[11px] line-clamp-1" title={q.lesson}>Bài: <span className="text-gray-700 font-medium">{q.lesson}</span></div>}
                           {q.math_form && (
                              <div className="text-amber-700 text-[11px] flex items-center gap-1.5">
                        ...
                        <div className="text-[13px] text-gray-800 font-medium prose prose-sm max-w-none prose-p:my-1 line-clamp-3 leading-relaxed">
                           <ReactMarkdown remarkPlugins={[remarkPhysics]} rehypePlugins={[rehypeKatex]}>{q.content || ""}</ReactMarkdown>
                        </div>
                     </div>
                   </div>
                 )
