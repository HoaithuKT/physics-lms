  ...
  const processImportedData = async (rows: any[]) => {
    try {
      ...
      if (insertData.length === 0) {
        alert("File không có dữ liệu hợp lệ. Vui lòng đảm bảo các cột có tên là: Lớp, Phân môn, Chuyên đề, Tên bài, Dạng vật lý.");
        setIsImporting(false);
        return;
      }
      ...
      <div className="w-full h-full flex flex-col overflow-hidden">
        ...
        {isManualAdding && (
          <div className="bg-blue-50 border-b border-blue-100 p-5 flex items-end gap-3 flex-wrap">
            ...
            <div className="flex flex-col gap-1 flex-1 min-w-[200px]">
              <label className="text-xs font-bold text-blue-800">Dạng vật lý *</label>
        ...
        <div className="flex-1 overflow-auto bg-gray-50/30">
          {categories.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center p-12 text-center">
              ...
              <p className="text-gray-500 max-w-sm mx-auto mb-6 text-sm">Bạn có thể sử dụng file Excel (.xlsx) với 5 cột: Lớp, Phân môn, Chuyên đề, Tên bài, Dạng vật lý để nhập hàng loạt.</p>
