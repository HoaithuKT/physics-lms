...
// có câu của nhiều phân môn khác nhau. Bắt thầy cô chọn một phân môn
// trước khi phân tích là ép sai ngay từ đầu - câu của phân môn này sẽ bị dồn sang phân môn khác.
//
 ...
 *
 * KHÔNG tự đánh số chương. Bản đầu ghi "CHƯƠNG 2: Chương 1. Cấu trúc của chất..." vì nghĩ
 * đánh số cho dễ nhìn, nhưng tên thật vốn đã mở đầu bằng "Chương N." nên hai con số chồng
 * lên nhau; máy chép lại nguyên cụm rồi trả về "Chương 2. Chương 1. Cấu trúc của chất..." -
...
export function dungPromptPhanBo(params: {
  ...
  // câu đầu thuộc Đại số rồi kéo cả lô về phân môn đó cho "nhất quán".
...
3. "math_form" ưu tiên chọn trong danh sách dạng của đúng bài đó, và đặt "dangMoi": false.
   ...
   tên đó phải mô tả đúng kiểu bài (VD "Tính suất điện động cảm ứng trong khung dây"), không
