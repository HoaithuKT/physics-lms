...
> \`/soan-chuong-thpt\` chương Dao động, Vật lí 11
...
> \`/soi-phieu-cham\` thư mục \`G:\\My Drive\\Ảnh chấm lí 12\`

Đo trên 15 phiếu thật (lớp Toán 12, hai app dùng chung bộ đọc): máy đọc đúng **468/468** vết tô, gắn cờ **11 câu**
...
1. **✨ AI soạn lời còn trống** — máy đọc nội dung từng mảnh rồi viết 2–3 câu lời giảng
   ...
   Máy **không bao giờ đè lên lời cô đã sửa**. Đọc lại, sửa từng ô, bấm **Lưu lời giảng**.
...
- **Máy chiếu**: vào slide là tự đọc. Slide có nhiều ý thì **đọc xong ý nào hiện ý ấy** —
  cô không phải bấm. Nút **🔊 Giọng đọc: BẬT/TẮT** ở thanh trên, cạnh đó là nút đọc lại.
...
- **Học sinh**: mỗi trang bài giảng có nút **Nghe cô giảng trang này**, nghe hết trang rồi
...
cô sửa lời rồi thu lại đúng đoạn đó — các đoạn khác giữ nguyên. Bên trang học sinh, mảnh
