...
/* ===================== DẤU ĐỘI ĐẦU: VECTƠ, GẠCH NGANG, DẤU MŨ =====================
   ...
   vectơ mất hẳn. Kho Lý có 711 lệnh vectơ ở 172 câu, kho Toán 6107 lệnh ở
   372 câu - nghĩa là mọi đề hình học không gian in ra đều sai ký hiệu.
...
function parseCommand(s: string, i: number): ParseResult {
  ...
  switch (name) {
    ...
    case "widehat":
    case "hat": {
      // Trong đề phổ thông, \widehat{ABC} luôn là KÝ HIỆU GÓC (rà ngân hàng app Toán
      // thấy 7229 lần, đều là góc: \widehat{COA}, \widehat{BOC}...). Xuất thành "∠ABC"
